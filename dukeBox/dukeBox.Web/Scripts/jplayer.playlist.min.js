...
(function ($, undefined) {
	...
	jPlayerPlaylist.prototype = {
		...
		next: function () {
			...
			if (typeof this.options.playlistOptions.nextHandler != 'undefined') {
			    this.options.playlistOptions.nextHandler();
			}
		},
		swap: function (bottomSongIndex, topSongIndex) {
		    var topSong = this.playlist[topSongIndex];
		    this.playlist[topSongIndex] = this.playlist[bottomSongIndex];
		    this.playlist[bottomSongIndex] = topSong;

		    var topSongO = this.original[topSongIndex];
		    this.original[topSongIndex] = this.original[bottomSongIndex];
		    this.original[bottomSongIndex] = topSongO;
