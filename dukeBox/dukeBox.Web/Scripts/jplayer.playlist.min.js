...
(function ($, undefined) {
	...
	jPlayerPlaylist.prototype = {
		...
		swap: function(bottomSongId, topSongId) {
		    var self = this;
		    var bottomSongIndex;
		    var topSongIndex;

		    for (var i = 0; i < self.playlist.length; i++) {
		        if (self.playlist[i].id == bottomSongId) {
		            bottomSongIndex = i;
		        }
		        if (self.playlist[i].id == topSongId) {
		            topSongIndex = i;
		        }
		    }

		    var topSong = self.playlist[topSongIndex];
		    self.playlist[topSongIndex] = self.playlist[bottomSongIndex];
		    self.playlist[bottomSongIndex] = topSong;
